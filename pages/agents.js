...
const agents = [
  ...
  },
  {
    ...
    uptime: "Uptime unavailable",
    memory: [
      "Grimmond Proposal v1 + v2 \u2014 completed (verified)",
      "Program 1 v3 \u2014 completed (verified)",
      "Program 2 v3 \u2014 completed (verified)",
      "Cover Page Test \u2014 completed (verified)",
      "Task Centre cleanup \u2014 completed (verified)",
    ],
    history: [
      { action: "GRIMMOND_PROPOSAL_BRANDED.pdf", time: "2026-03-23 04:49", type: "success" },
      { action: "GRIMMOND_PROPOSAL_BRANDED_v2.pdf", time: "2026-03-23 09:52", type: "success" },
      ...
      { action: "Cover page test PDF", time: "2026-03-23 17:18", type: "success" },
  ...
  },
  {
    ...
    uptime: "Uptime unavailable",
    memory: [
      "Primary document engine for Supercharged Tradies",
      "Brand: #2F8FE6 blue, black headings, white background",
    ],
    history: [
      { action: "PROGRAM1 v3 via Manus", time: "2026-03-23 20:39", type: "success" },
      { action: "PROGRAM2 v3 via Manus", time: "2026-03-23 20:48", type: "success" },
